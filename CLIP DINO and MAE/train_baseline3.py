...
class MultiView_Dataset(Dataset):
    def __init__(self, features_dict):
        ...
        self.mae_features = features_dict["mae_features"]    # [N, 768]
...
def train_and_evaluate():
    ...
    features_dict = torch.load("multiview3_train_features.pt", map_location="cpu")
    ...
    for epoch in range(epochs):
        ...
        for clip_feat, dino_feat, mae_feat, labels in train_loader:
    ...
    torch.save(model.state_dict(), "multiview3_fusion_mlp.pth")
    print("\n训练完成！权重已保存至 multiview3_fusion_mlp.pth")
